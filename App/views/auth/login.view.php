...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-500 mx-6 border border-gray-200">
        <h2 class="text-4xl text-center font-bold mb-6">Login</h2>
        ...
        <form action="/auth/login" method="POST">
            ...
            <p class="mt-4 text-sm text-gray-600 text-center">
                Don't have an account? <a href="/auth/register" class="text-indigo-600 font-bold underline hover:text-indigo-800">Register</a>
            </p>
        </form>
    </div>
</section>
